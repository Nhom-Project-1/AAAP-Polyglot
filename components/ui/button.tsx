...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-white text-black border-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-slaye-100 text-slate-500",
        primary: "bg-pink-400 text-primary-foreground hover:bg-pink-400/90 border-pink-500 border-b-4 active:border-b-0",
        primaryOutline:"bg-white text-pink-500 hover:bg-slate-100",
        secondary:
          "bg-pink-400 text-primary-foreground hover:bg-pink-500/90 border-pink-600 border-b-4 active:border-b-0",
          secondaryOutline:"bg-white text-pink-500 hover:bg-slate-100",
        ghost:
          "bg-transparent hover:bg-slate-500 border-transparent border-0 hover:bg-slate-100",
