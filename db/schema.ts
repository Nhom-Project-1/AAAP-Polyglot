...
export const quan_ly_nguoi_dung = pgTable('quan_ly_nguoi_dung', {
  ...
  ma_admin: integer('ma_admin').references(() => admin.ma_admin, {
    onDelete: 'cascade',
  }),
  ma_nguoi_dung: integer('ma_nguoi_dung').references(
...
export const unit = pgTable('unit', {
  ...
  ma_ngon_ngu: integer('ma_ngon_ngu').references(() => ngon_ngu.ma_ngon_ngu, {
    onDelete: 'cascade',
  }),
...
export const bai_hoc = pgTable('bai_hoc', {
  ...
  ma_don_vi: integer('ma_unit').references(() => unit.ma_don_vi, {
    onDelete: 'cascade',
  }),
...
export const tu_vung = pgTable('tu_vung', {
  ...
  ma_bai_hoc: integer('ma_bai_hoc').references(() => bai_hoc.ma_bai_hoc, {
    onDelete: 'cascade',
  }),
...
export const lua_chon_thu_thach = pgTable('lua_chon_thu_thach', {
  ...
  ma_thu_thach: integer('ma_thu_thach').references(
    () => thu_thach.ma_thu_thach,
    { onDelete: 'cascade' },
  ),
...
export const cau_tra_loi_nguoi_dung = pgTable('cau_tra_loi_nguoi_dung', {
  ...
  ma_lua_chon: integer('ma_lua_chon').references(
    () => lua_chon_thu_thach.ma_lua_chon,
    { onDelete: 'cascade' },
  ),
...
export const tien_do_muc_tieu = pgTable('tien_do_muc_tieu', {
  ma_nguoi_dung: integer('ma_nguoi_dung').references(
    () => nguoi_dung.ma_nguoi_dung,
    { onDelete: 'cascade' },
  ),
  ma_muc_tieu: integer('ma_muc_tieu').references(() => muc_tieu.ma_muc_tieu, {
    onDelete: 'cascade',
  }),
